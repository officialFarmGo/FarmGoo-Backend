exports.signUpOtpTemplateForDrivers = (name, otp) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 500px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                        ...
                        <tr>
                            <td align="center" style="padding: 30px 20px; background-color: #1a1a2e; border-bottom: 1px solid #16213e;">
                                <p style="margin: 0 0 6px; font-size: 12px; color: #a0a0b0; text-transform: uppercase; letter-spacing: 1.5px;">Driver Portal</p>
                        ...
                        <tr>
                            <td class="content" style="padding: 40px; text-align: center; color: #333333;">
                                ...
                                <h2 style="margin: 0 0 10px; font-size: 22px; font-weight: 700; color: #1a1a2e;">Welcome, Driver!</h2>
                                <p style="font-size: 16px; line-height: 1.5; margin: 0 0 30px; color: #666666;">
                                    Hi <strong>${name}</strong>, your driver account on <strong>FarmGoo</strong> is almost ready! Use the OTP below to verify your email and start delivering fresh farm produce.
                                </p>
                                ...
                                <div style="background-color: #fff8f0; border-left: 4px solid #f4a261; border-radius: 0 8px 8px 0; padding: 14px 16px; margin: 24px 0 0; text-align: left;">
                                    <p style="margin: 0; font-size: 13px; color: #c1440e; line-height: 1.5;">
                                        🚛 <strong>Once verified</strong>, you'll have full access to the FarmGoo driver dashboard — view delivery assignments, track routes, and manage your earnings all in one place.
                                    </p>
                                </div>

                                <!-- Warning -->
                                <p style="font-size: 13px; color: #999999; margin-top: 30px; line-height: 1.4; border-top: 1px solid #f3f4f6; padding-top: 20px;">
                                    <strong>Didn't sign up as a driver?</strong> You can safely ignore this email. Someone may have entered your email by mistake.
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center" style="padding: 25px; background-color: #1a1a2e; font-size: 12px; color: #a0a0b0;">
                                <p style="margin: 0; color: #f4a261;">🚚 On the road, keeping farms connected.</p>
...
exports.resetPasswordSuccessfulTemplateForDriver = (name) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 500px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                        ...
                        <tr>
                            <td class="content" style="padding: 40px; text-align: center; color: #333333;">
                                ...
                                <p style="font-size: 16px; line-height: 1.5; margin: 0 0 30px; color: #666666;">
                                    Hi ${name}, your <strong>FarmGoo</strong> driver account password has been successfully updated. You can now log back in and get back on the road.
                                </p>
                                ...
                                <div style="background-color: #fff8f0; border-left: 4px solid #f4a261; border-radius: 0 8px 8px 0; padding: 14px 16px; margin: 30px 0 0; text-align: left;">
                                    <p style="margin: 0; font-size: 13px; color: #c1440e; line-height: 1.5;">
                                        🚛 <strong>Security tip</strong> — use a strong password you don't use on other apps to keep your driver account and earnings safe.
                                    </p>
                                </div>
...
exports.forgetPasswordTemplateForDriver = (name, otp) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 500px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                        ...
                        <tr>
                            <td class="content" style="padding: 40px; text-align: center; color: #333333;">
                                ...
                                <p style="font-size: 16px; line-height: 1.5; margin: 0 0 30px; color: #666666;">
                                    Hi ${name}, we received a request to reset your <strong>FarmGoo</strong> driver account password. Use the OTP below to proceed. If you didn't request this, you can safely ignore this email.
                                </p>
...
exports.resendOtpTemplateForDrivers = (name, otp) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 500px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                        ...
                        <tr>
                            <td class="content" style="padding: 40px; text-align: center; color: #333333;">
                                ...
                                <p style="font-size: 16px; line-height: 1.5; margin: 0 0 30px; color: #666666;">
                                    Hi <strong>${name}</strong>, you requested a new verification code. Your previous OTP has been invalidated — use the one below to verify your driver account.
                                </p>
                                ...
                                <div style="background-color: #fff8f0; border-left: 4px solid #f4a261; border-radius: 0 8px 8px 0; padding: 14px 16px; margin: 24px 0; text-align: left;">
                                    <p style="margin: 0; font-size: 13px; color: #c1440e; line-height: 1.5;">
                                        🚛 If you didn't request a new code, your driver account may be at risk. Please <a href="#" style="color: #e76f1e; text-decoration: none;">contact support</a> immediately.
                                    </p>
                                </div>
